...
from our pre-built/compiled builds will be described. For instructions on
installing from source code please refer to our `README`_.

You can always find our latest release on our `GitHub Releases`_ page. The latest
release will always be at the top of this page. From there, there should be a section
...
From there, download the appropriate package for your operating system.
...
:emphasis:`Note: We recommend that any world that is to be opened by Amulet is backed up
...
* ``Convert`` - The Amulet world converter, see :doc:`/world_converter`
* ``3D Editor`` - The Amulet 3D editor, see :doc:`/world_editor`
