...
- Amulet
- The world you want to convert (referred to as the `source world`)
- A world from the same Minecraft platform and version you want the world to be converted to (referred to as the `destination world`)
...
![The Convert sub-program can be found on the left side of the world screen](/images/world_screen_converter.png)
...
![Conversion finished](/images/conversion_finished.png)
